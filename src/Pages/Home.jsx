...
//         console.log(data);
//         setParks(data.Search || [])
//     }

//     useEffect(()=>{
//         fetchParks('National parks');
//     })
//   return (
//     <div className="min-h-screen bg-gradient-to-b from-emerald-50 to-blue-50 py-10">
//       <div className="max-w-6xl mx-auto p-4">
//         <form className="flex gap-2 justify-center mb-10">
//           <input
//             type="text"
//             placeholder="Search Park"
//             className="border-2 rounded-full px-5 py-3 w-80 bg-white focus:outline-none focus:border-blue-400 transition-colors"
//           />
//           <button className="bg-blue-600 hover:bg-blue-700 text-white rounded-full px-6 py-3 font-medium transition-colors cursor-pointer">
//             Search 🔎
//           </button>
//         </form>
...
//     // Filter to only parks whose name actually contains the search term
...
//     <div className="min-h-screen bg-gradient-to-b from-emerald-50 to-blue-50 py-10">
//       <div className="max-w-6xl mx-auto p-4">
//         <form onSubmit={handleSubmit} className="flex gap-2 justify-center mb-10">
//           <input 
//             type="text"
//             value={query}
